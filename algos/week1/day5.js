...
function slice(items, startIdx, endIdx) {
  // SETUP
  // I need a new array to be able to fill it with the slice of the input array.
  var slicedArr = []
  ...
  // RETURN
  // I need to return the sliced array
  return slicedArr
}
...
function concat(items1, items2) {
  // SETUP
  // I need a new array to hold the combination of the two input arrays
  var newArr = []
